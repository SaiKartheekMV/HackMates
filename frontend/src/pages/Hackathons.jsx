...
const Hackathons = () => {
  ...
  const mockHackathons = [
    {
      ...
      description: "Forge the future of consciousness with neural networks that transcend human limitations. Build AI systems that merge reality with digital dreams.",
    ...
    },
    {
      ...
      description: "Break the chains of centralized control. Build autonomous systems that exist beyond corporate oversight in the digital underground.",
    ...
    },
    {
      ...
      description: "The planet is dying. Code the solutions that will save humanity from environmental collapse using cutting-edge biotechnology.",
      ...
      tags: ["Climate Tech", "Bioengineering", "Sustainability", "Planetary Defense"],
    ...
    },
    {
      ...
      description: "Infiltrate the financial system with revolutionary technology. Build the tools that will democratize wealth in the digital age.",
      ...
      tags: ["FinTech", "Digital Banking", "Crypto Payments", "Financial Liberation"],
  ...
  const filterAndSortHackathons = () => {
    let filtered = hackathons.filter(hackathon => {
      ...
      const matchesStatus = filters.status === 'all' || hackathon.status === filters.status;
      const matchesMode = filters.mode === 'all' || hackathon.mode === filters.mode;
      const matchesDifficulty = filters.difficulty === 'all' || hackathon.difficulty === filters.difficulty;
      ...
      if (filters.prizeRange !== 'all') {
        switch (filters.prizeRange) {
          case 'low':
            ...
            break;
          case 'medium':
            matchesPrizeRange = hackathon.prizePool >= 3000000 && hackathon.prizePool < 6000000;
            break;
          case 'high':
      ...
      return matchesSearch && matchesStatus && matchesMode && matchesDifficulty && matchesPrizeRange;
    });
    ...
    return (
      <div style={{
        ...
        <div className="text-center">
          ...
          <p className="mt-3" style={{ fontFamily: 'monospace', fontSize: '18px' }}>
            ACCESSING HACKATHON DATABASE...
          </p>
          <p style={{ fontFamily: 'monospace', fontSize: '14px', opacity: 0.7 }}>
    ...
    <div style={{
      ...
      <Container fluid className="py-4 grid-background">
        ...
        <Row className="mb-5">
          <Col>
            <div className="text-center">
              <h1 className="display-4 fw-bold mb-2 neon-text glitch-title" style={{ 
                color: '#00ffff',
        ...
        <Row className="mb-4">
          <Col md={3}>
            <Form.Label className="fw-bold small" style={{ color: '#00ffff', fontFamily: 'monospace' }}>
              STATUS
            </Form.Label>
            <Form.Select
              className="cyber-input"
        ...
        <Row className="mb-3">
          <Col>
            <p style={{ color: '#ff00ff', fontFamily: 'monospace', margin: 0 }}>
              NEURAL SCAN COMPLETE: {filteredHackathons.length} / {hackathons.length} EVENTS FOUND
            </p>
          </Col>
        </Row>
              ...
              <Col lg={6} xl={4} key={hackathon.id} className="mb-4">
                ...
                >
                  <div 
                    ...
                    style={{ 
                      backgroundColor: hackathon.status === 'ongoing' ? '#00ff00' : 
                                     hackathon.status === 'upcoming' ? '#ffff00' : '#666'
                    }}
                  ></div>
                  ...
                  <Card.Body className="p-4">
                    ...
                    <Card.Title 
                      ...
                      style={{ 
                        ...
                        fontSize: '18px',
                        fontWeight: 'bold',
                        textShadow: hoveredCard === hackathon.id ? '0 0 10px #00ffff' : 'none'
                      }}
                    >
                      {hackathon.title}
                    </Card.Title>
                    ...
                    <div className="mb-3" style={{ fontFamily: 'monospace', fontSize: '12px' }}>
                      ...
                      <div className="d-flex justify-content-between mb-1">
                        ...
                        <span style={{ color: '#ffff00' }}>{hackathon.location}</span>
                      </div>
                      <div className="d-flex justify-content-between">
                        <span style={{ color: '#888' }}>CREW SIZE:</span>
                        <span style={{ color: '#ff00ff' }}>{hackathon.maxTeamSize} MAX</span>
                      </div>
                    </div>
        ...
        >
          ...
          >
            {selectedHackathon && (
              <div>
                <h5 style={{ color: '#ff00ff' }}>{selectedHackathon.subtitle}</h5>
                <p>{selectedHackathon.description}</p>
                
                <Row className="mb-3">
                  <Col md={6}>
                    <strong style={{ color: '#00ffff' }}>Start Date:</strong><br/>
                    {new Date(selectedHackathon.startDate).toLocaleDateString()}
                  </Col>
                  <Col md={6}>
                    <strong style={{ color: '#00ffff' }}>End Date:</strong><br/>
                ...
                <Row className="mb-3">
                  <Col md={6}>
                    <strong style={{ color: '#00ffff' }}>Prize Pool:</strong><br/>
                    <span style={{ color: '#00ff00' }}>{formatPrize(selectedHackathon.prizePool)}</span>
                  </Col>
                  <Col md={6}>
                    <strong style={{ color: '#00ffff' }}>Team Size:</strong><br/>
                    {selectedHackathon.maxTeamSize} members max
                  </Col>
                </Row>
                
                <div className="mb-3">
                  <strong style={{ color: '#00ffff' }}>Tags:</strong><br/>
